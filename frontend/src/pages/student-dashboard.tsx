      ...
      try {
        ...
        if (appError) {
          ...
          const formattedApp: Application = {
            ...
            program: appData.program || t("review.notProvided"),
            institution: appData.institution || t("review.notProvided"),
            studyPeriod: appData.study_period || t("review.notProvided"),
    ...
    switch (normalizedStatus) {
      case 'submitted':
        return {
          ...
          label: t("studentDashboard.status.submitted.label"),
          description: t("studentDashboard.status.submitted.description")
        };
      case 'in review':
      case 'in-review':
      case 'reviewing':
        return {
          ...
          label: t("studentDashboard.status.inReview.label"),
          description: t("studentDashboard.status.inReview.description")
        };
      case 'in-progress':
      case 'in progress':
      case 'pending':
        return {
          ...
          label: t("studentDashboard.status.inProgress.label"),
          description: t("studentDashboard.status.inProgress.description")
        };
      case 'accepted':
      case 'approved':
        return {
          ...
          label: t("studentDashboard.status.accepted.label"),
          description: t("studentDashboard.status.accepted.description")
        };
      case 'denied':
      case 'rejected':
        return {
          ...
          label: t("studentDashboard.status.denied.label"),
          description: t("studentDashboard.status.denied.description")
        };
      default:
        ...
        return {
          ...
          label: status || t("studentDashboard.status.unknown.label"),
          description: t("studentDashboard.status.unknown.description")
        };
    }
  };
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-center items-center h-64">
              <div className="text-center">
                ...
                <p className="text-gray-700">{t("studentDashboard.loading")}</p>
              </div>
            </div>
          </div>
        </main>
        ...
        <main className="py-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">{t("studentDashboard.noApplication.title")}</h2>
              <p className="text-gray-700 mb-6">{t("studentDashboard.noApplication.message")}</p>
              <Link
                href="/application"
                className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
              >
                {t("studentDashboard.noApplication.startNew")}
              </Link>
            </div>
          </div>
        </main>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Page Title */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">{t("studentDashboard.header.pageTitle")}</h1>
            <p className="mt-2 text-gray-700">
              {t("studentDashboard.header.dashboardDescription")}
            </p>
          </div>
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <span className="text-sm text-gray-700">
                    {t("studentDashboard.status.lastUpdated")} {new Date(application.statusUpdatedDate).toLocaleDateString('en-US', { 
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  ...
                  >
                    ...
                    {t("studentDashboard.actions.downloadPdf")}
                  </button>
                  {application.status === 'in-progress' && (
                    <button className="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors text-sm font-medium">
                      ...
                      {t("studentDashboard.actions.submitRequiredDocuments")}
                    </button>
                  )}
                  {application.status === 'accepted' && (
                    <button className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm font-medium">
                      <Download className="h-4 w-4 mr-2" />
                      {t("studentDashboard.actions.downloadApprovalLetter")}
                    </button>
                  )}
                </div>
              </div>
          ...
          <div className="mb-6 border-b border-gray-200">
            <nav className="flex space-x-8">
              ...
              >
                {t("studentDashboard.tabs.overview")}
              </button>
              <button
              ...
              >
                {t("studentDashboard.tabs.details")}
              </button>
              <button
              ...
              >
                {t("studentDashboard.tabs.timeline")}
              </button>
            </nav>
          </div>
